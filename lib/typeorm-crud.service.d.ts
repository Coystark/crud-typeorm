...
import { Brackets, ObjectLiteral, Repository, SelectQueryBuilder, ConnectionOptions, EntityMetadata } from 'typeorm';
...
export declare class TypeOrmCrudService<T> extends CrudService<T> {
    ...
    createOne(req: CrudRequest, dto: T | Partial<T>): Promise<T>;
    createMany(req: CrudRequest, dto: CreateManyDto<T | Partial<T>>): Promise<T[]>;
    ...
    protected setAndWhere(cond: QueryFilter, i: any, builder: SelectQueryBuilder<T>): void;
    protected setOrWhere(cond: QueryFilter, i: any, builder: SelectQueryBuilder<T>): void;
